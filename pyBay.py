...
# TODO: exclude arg needs to be case insensitive
...
for page in range(1):
    url = f"https://www.ebay.com/sch/i.html?_from=R40&_nkw={keywords}&_sacat=0&rt=nc&LH_Sold=1&LH_Complete=1&_ipg=200&_pgn={page}" # &_pgn=1
    get_listings(url)
